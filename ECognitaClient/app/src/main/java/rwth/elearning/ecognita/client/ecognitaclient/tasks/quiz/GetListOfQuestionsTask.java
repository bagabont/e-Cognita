 ...
 */
public class GetListOfQuestionsTask {
    ...
    private class HttpGetListOfQuestionsTask extends AsyncTask<QuizListItem, Void, List<QuestionItem>> {
        ...
        protected List<QuestionItem> doInBackground(QuizListItem... args) {
            ...
            try {
                ...
                URL url = new URL(LogInFragment.HOST_ADDRESS + ApiPathEnum.GET_QUIZ_QUESTIONS.getPath() + quizListItem.getId() + "/questions");
                ...
                switch (responseCode) {
                    case OK:
                        ...
                        br.close();
                        return JSONQuizQuestionsParser.parse(sb.toString());
                }
